...
<body>
	<div class="table-responsive col-10 offset-1">
		<a class="btn btn-success" href="/assignment/account/create">
			Create </a>
		<table class="table">
			<thead>
				<tr>
				...
				<c:forEach items="${ acc.content }" var="acc">
					<tr>
						...
						<td><a class="btn btn-primary"
							href="/assignment/account/edit/${ acc.id }"> Update </a></td>
						<td><a class="btn btn-danger"
							href="/assignment/account/delete/${ acc.id }"> Delete </a></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
			...
			<ul class="pagination">
				<c:forEach var="index" begin="0" end="${ acc.totalPages - 1 }">
					<li class="page-item"><a class="page-link"
						href="/assignment/account/index?page=${ index }">${ index + 1 }</a>
					</li>
				</c:forEach>
			</ul>
		</div>
